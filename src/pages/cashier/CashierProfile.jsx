...
import { CheckCircle, DollarSign, FileText, UploadCloud, User, Clock } from "lucide-react";

// Placeholder images from Unsplash
const cashierAvatar = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"; // Cashier portrait
const bannerImage = "https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"; // Office desk background

// Dummy Data for a Cashier
const dummyCashier = {
  id: "CSH001",
  name: "Amina Juma",
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-gray-100 text-gray-800">
        ...
        <div className="p-6 md:p-12 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white shadow-lg rounded-lg p-6 flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-800 font-bold">{dummyCashier.id}</p>
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-800 font-bold">TZS {dummyCashier.paymentsToday.toLocaleString()}</p>
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-800 font-bold">TZS {dummyCashier.totalProcessed.toLocaleString()}</p>
                <p className="text-gray-500">Lifetime Collections</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 mb-8 hover:bg-yellow-50 transition duration-300 transform hover:scale-105">
            ...
            <p className="text-gray-800 text-lg">Last transaction recorded: <span className="font-bold">{dummyCashier.lastActivity}</span></p>
            <p className="text-gray-500 mt-2">Keep up the great work managing student payments!</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-green-50 rounded-lg shadow-md text-center animate-bounce-in">
            <p className="text-lg font-semibold text-green-800">
              Great job, {dummyCashier.name}! You’re keeping the school finances on track! 💰
            </p>
          </div>
        </div>
      </div>
...
// const { data: cashier = {}, isPending } = useQuery({
//     queryKey: ["cashier-profile"],
//     queryFn: () => axiosInstance.get("/api/cashier/me").then(res => res.data),
//   });
//   const { mutate: updatePassword } = useMutation({
//     mutationFn: ({ oldPassword, newPassword }) => axiosInstance.put(`/api/password/${cashier.id}/update`, { old_password: oldPassword, password: newPassword }),
